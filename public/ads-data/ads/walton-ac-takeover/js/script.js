...
document.querySelector('.ppm_remote').addEventListener('click',(e)=>{if(!remoteClicked){e.stopPropagation();remoteClick();submitInteraction('remote_tap',extraData);}})
document.querySelector('.ppm_tap_hand').addEventListener('click',(e)=>{if(!remoteClicked){e.stopPropagation();remoteClick();submitInteraction('remote_tap',extraData);}})
