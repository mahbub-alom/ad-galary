...
function handleClick(){
 ...
 .fromTo('.ppm_fire',{scale:0,display:'none',opacity:0},{scale:1,x:0,y:0,display:'block',opacity:1,duration:0.5,ease:'none'},'<')
 .to(['.ppm_tv','.ppm_ac','.ppm_ref'],{duration:0.5,y:-5,ease:'none',repeat:4,yoyo:true},'>')
 ...
 .to('.ppm_fire',{duration:0.5,scale:0,display:'none',opacity:0,ease:'none'},'<')
}
