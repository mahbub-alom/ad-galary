checker = true;
gsap.to('.pp_hand', { scaleX:1.15,scaleY:1.1, duration: .6,repeat:-1,yoyo:true })
...
function goalDrawEnd() {
  gsap.timeline()
    ...
    .to(['.pp_watch','.pp_buds','.pp_a73'],{scaleX:1.1,scaleY:1.1,duration:.5,stagger:.1,repeat:2,yoyo:true},'>')
