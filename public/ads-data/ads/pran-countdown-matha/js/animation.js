...
function checkIftarTime(todayDate, curTime) {
    ...
    if (diffTime<setTime && diffTime>=0){
        displayTitle.src = "https://ms.purplepatch.online/ramadan/2024/countdown/pran-matha/v2/assets/iftar.png";
...
function checkSehriTime(todayDate, curTime) {
    ...
    if (diffTime<setTime && diffTime>=0){
        displayTitle.src = "https://ms.purplepatch.online/ramadan/2024/countdown/pran-matha/v2/assets/sehri.png";
