...
function checkIftarTime(todayDate, curTime) {
    ...
    if (diffTime<setTime && diffTime>=0){
        displayTitle.src = "https://ms.purplepatch.online/ramadan/2024/countdown/smc/v1/assets/iftar.png";
        // displayIftarText.src = "https://ms.purplepatch.online/ramadan/2024/countdown/smc/v1/assets/iftartext.png";
...
function checkSehriTime(todayDate, curTime) {
    ...
    if (diffTime<setTime && diffTime>=0){
        displayTitle.src = "https://ms.purplepatch.online/ramadan/2024/countdown/smc/v1/assets/sehri.png";
        // displayIftarText.src = "https://ms.purplepatch.online/ramadan/2024/countdown/smc/v1/assets/sehritext.png";
        displayCounter.innerHTML = printTimer(diffTime);
