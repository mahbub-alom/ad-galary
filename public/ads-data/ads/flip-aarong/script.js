...
function completeOperation() {
  ...
  if (!activeFront) frontElm.style.backgroundImage = `url('https://ms.purplepatch.online/flip/aarong/may-24/assets/${array[current]}.png')`
  else backElm.style.backgroundImage = `url('https://ms.purplepatch.online/flip/aarong/may-24/assets/${array[current]}.png')`
  nextElement()
