function fillAnimation() {
  gsap.timeline()
  .to(['.tapText','.ppm_tapIcon'],{opacity:0,display:'none'})
  gsap.timeline({ delay: .2 })
    ...
    .to('.ppm_ushnotaText', {
      scaleX: 1.1, scaleY: 1.1, duration: .7, repeat: -1
      , yoyo: true
    }, '>.2')
}

gsap.to('.ppm_tapIcon',{scaleX:.9,scaleY:.9,repeat:-1,yoyo:true})

document.querySelector('.ppm_tapIcon').addEventListener('click',fillAnimation)
document.querySelector('.ppm_teapot').addEventListener('click',fillAnimation)