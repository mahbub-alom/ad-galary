...
gsap.timeline()
  ...
  .to('.ppm_slide_1',1, { display: "none", opacity: 0, }, "<")
  .fromTo(".ppm_cta_btn", .5, { display: "none", opacity: 0, }, { display: "block", opacity: 1,onComplete:()=>{
...
document.querySelector(".ppm_slide_2").addEventListener("click", function (e) {
  e.stopPropagation();
window.open('https://www.facebook.com/parachutenaturalebd/?locale=bn_IN')
});
